...
enum {
  ...
  sym_function_def = 55,
  sym__context_table = 56,
  sym_global_table = 57,
  sym_local_table = 58,
  sym_instance_table = 59,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym__rvalue_expr] = STATE(17),
    [sym__lvalue_expr] = STATE(10),
    [sym_parenthesized] = STATE(10),
    [sym_function_call] = STATE(10),
    [sym_while] = STATE(10),
    [sym_index] = STATE(10),
    [sym_chained_string] = STATE(17),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_argument_list, 4),
  [53] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_argument_list, 4),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_index, 3, .production_id = 7),
  [57] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_index, 3, .production_id = 7),
  ...
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_index, 4, .production_id = 9),
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_index, 4, .production_id = 9),
  [75] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_chained_string, 2),
  [79] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_chained_string, 2),
  ...
  [87] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_chained_string_repeat1, 2), SHIFT_REPEAT(15),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2),
  [92] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(92),
  [95] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(16),
  [98] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(46),
  [101] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(49),
  [104] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(86),
  [107] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(2),
  [110] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(10),
  [113] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(17),
  [116] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(13),
  ...
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_conditional, 4, .production_id = 8),
  ...
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary, 3, .production_id = 5),
  [157] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary, 3, .production_id = 5),
  [159] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__inblock, 1),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary, 2, .production_id = 1),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary, 2, .production_id = 1),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_conditional, 5, .production_id = 11),
  [169] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__more_inblock_repeat1, 2), SHIFT_REPEAT(24),
  [172] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__more_inblock_repeat1, 2), SHIFT_REPEAT(46),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__more_inblock_repeat1, 2),
  [177] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__more_inblock_repeat1, 2), SHIFT_REPEAT(49),
  [180] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__more_inblock_repeat1, 2), SHIFT_REPEAT(86),
  [183] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__more_inblock_repeat1, 2), SHIFT_REPEAT(2),
  [186] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__more_inblock_repeat1, 2), SHIFT_REPEAT(10),
  [189] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__more_inblock_repeat1, 2), SHIFT_REPEAT(17),
  [192] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__more_inblock_repeat1, 2), SHIFT_REPEAT(13),
  [195] = {.entry = {.count = 1, .reusable = true}}, SHIFT(24),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__more_inblock, 2),
  [199] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__more_inblock, 1),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, .production_id = 5),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_conditional, 3, .production_id = 6),
  ...
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_def, 6, .production_id = 12),
  [237] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_def, 6, .production_id = 12),
  ...
  [249] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_def_repeat1, 2), SHIFT_REPEAT(82),
  [252] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_def_repeat1, 2), SHIFT_REPEAT(83),
  ...
  [285] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameter_list_repeat1, 2), SHIFT_REPEAT(76),
  [288] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameter_list_repeat1, 2),
  [290] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [292] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__inblock, 2),
  [296] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_argument, 1),
  [298] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [300] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_argument_list_repeat1, 2), SHIFT_REPEAT(43),
